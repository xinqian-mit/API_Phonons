...
for scell in Scells_phonopy:
    scell_qp = api_phon.phonopyAtoms_to_aseAtoms(scell)
...
api_phon.write_ShengBTE_FC2(phonon_scell.get_force_constants(), filename='FORCE_CONSTANTS_2ND')
# phonopy 2.7 changed format, ShengBTE won't read, use the file in api_qpv to write.

# calc and plot bandstructure
bands=api_phon.qpoints_Band_paths(Qpoints,Band_points)
